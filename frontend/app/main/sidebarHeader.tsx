...
const SidebarHeader = ({transitionDelay}: SidebarHeaderProps) => {
    ...
    const iconTransitionDelay = transitionDelay - 100;
    ...
    return (
        <div className="w-full flex items-center justify-between">
            <Image src="svgs/Reqal Logo - Dark Mode.svg" alt="ReQal logo" width={80} height={80}
                   className=""
            />
            {isIconVisible && <Image src="svgs/sidebar.svg" alt="Open Sidebar" width={40} height={40}
                                     className={clsx(` invert-100 transition-all duration-${iconTransitionDelay} ease-in-out cursor-pointer`, {"pointer-events-none opacity-0 mr-0": !isIconActive}, {"opacity-100 mr-6": isIconActive})}
