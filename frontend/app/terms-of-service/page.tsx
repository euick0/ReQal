            ...
            <div className="space-y-8">
                ...
                <section>
                    ...
                    <div className="space-y-4">
                        <p>
                            We are <strong>ReQal</strong> (&quot;<strong>Company</strong>&quot;, &quot;<strong>we</strong>&quot;, &quot;<strong>us</strong>&quot;, or &quot;<strong>our</strong>&quot;), 
                            a company based in Portugal.
                        </p>
                        <p>
                            We operate the website <a href="https://reqal.app" className="text-primary hover:underline">https://reqal.app</a> (the &quot;<strong>Site</strong>&quot;), 
                        ...
                        <p>
                            ...
                            <a href="mailto:help@support.reqal.app" className="text-primary hover:underline">help@support.reqal.app</a>.
                        </p>
                        <p>
                            ...
                            and ReQal, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, 
                            and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY 
                        ...
                        <p>
                            ...
                            <a href="mailto:noreply@support.reqal.app" className="text-primary hover:underline">noreply@support.reqal.app</a>, 
                            as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound 
                ...
                <section id="toc">
                    ...
                    <ol className="list-decimal pl-6 space-y-2">
                        <li><a href="#section-1" className="text-primary hover:underline">OUR SERVICES</a></li>
                        <li><a href="#section-2" className="text-primary hover:underline">INTELLECTUAL PROPERTY RIGHTS</a></li>
                        <li><a href="#section-3" className="text-primary hover:underline">USER REPRESENTATIONS</a></li>
                        <li><a href="#section-4" className="text-primary hover:underline">USER REGISTRATION</a></li>
                        <li><a href="#section-5" className="text-primary hover:underline">PROHIBITED ACTIVITIES</a></li>
                        <li><a href="#section-6" className="text-primary hover:underline">USER GENERATED CONTRIBUTIONS</a></li>
                        <li><a href="#section-7" className="text-primary hover:underline">CONTRIBUTION LICENCE</a></li>
                        <li><a href="#section-8" className="text-primary hover:underline">THIRD-PARTY WEBSITES AND CONTENT</a></li>
                        <li><a href="#section-9" className="text-primary hover:underline">SERVICES MANAGEMENT</a></li>
                        <li><a href="#section-10" className="text-primary hover:underline">PRIVACY POLICY</a></li>
                        <li><a href="#section-11" className="text-primary hover:underline">TERM AND TERMINATION</a></li>
                        <li><a href="#section-12" className="text-primary hover:underline">MODIFICATIONS AND INTERRUPTIONS</a></li>
                        <li><a href="#section-13" className="text-primary hover:underline">GOVERNING LAW</a></li>
                        <li><a href="#section-14" className="text-primary hover:underline">DISPUTE RESOLUTION</a></li>
                        <li><a href="#section-15" className="text-primary hover:underline">CORRECTIONS</a></li>
                        <li><a href="#section-16" className="text-primary hover:underline">DISCLAIMER</a></li>
                        <li><a href="#section-17" className="text-primary hover:underline">LIMITATIONS OF LIABILITY</a></li>
                        <li><a href="#section-18" className="text-primary hover:underline">INDEMNIFICATION</a></li>
                        <li><a href="#section-19" className="text-primary hover:underline">USER DATA</a></li>
                        <li><a href="#section-20" className="text-primary hover:underline">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a></li>
                        <li><a href="#section-21" className="text-primary hover:underline">MISCELLANEOUS</a></li>
                        <li><a href="#section-22" className="text-primary hover:underline">CONTACT US</a></li>
                    </ol>
                </section>
                ...
                <section id="section-8" className="scroll-mt-8">
                    <h2 className="text-2xl font-semibold mb-4">8. THIRD-PARTY WEBSITES AND CONTENT</h2>
                    <div className="space-y-4">
                ...
                <section id="section-9" className="scroll-mt-8">
                    <h2 className="text-2xl font-semibold mb-4">9. SERVICES MANAGEMENT</h2>
                    <div className="space-y-4">
                ...
                <section id="section-10" className="scroll-mt-8">
                    ...
                    <div className="space-y-4">
                        <p>We care about data privacy and security. Please review our Privacy Policy: https://reqal.com/privacy-policy. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in Ireland. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in Ireland, then through your continued use of the Services, you are transferring your data to Ireland, and you expressly consent to have your data transferred to and processed in Ireland.</p>
                    </div>
                </section>
                ...
                <section id="section-12" className="scroll-mt-8">
                    <h2 className="text-2xl font-semibold mb-4">12. MODIFICATIONS AND INTERRUPTIONS</h2>
                    <div className="space-y-4">
                ...
                <section id="section-13" className="scroll-mt-8">
                    ...
                    <div className="space-y-4">
                        <p>These Legal Terms are governed by and interpreted following the laws of Portugal, and the use of the United Nations Convention of Contracts for the International Sales of Goods is expressly excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the law in your country to residence. ReQal and yourself both agree to submit to the non-exclusive jurisdiction of the courts of Lisbon, which means that you may make a claim to defend your consumer protection rights in regards to these Legal Terms in Portugal, or in the EU country in which you reside.</p>
                    </div>
                </section>
                ...
                <section id="section-14" className="scroll-mt-8">
                    ...
                    <div className="space-y-4">
                        <p>Informal NegotiationsTo expedite resolution and control the cost of any dispute, controversy, or claim related to these Legal Terms (each a 'Dispute' and collectively, the 'Disputes') brought by either you or us (individually, a 'Party' and collectively, the 'Parties'), the Parties agree to first attempt to negotiate any Dispute (except those Disputes expressly provided below) informally for at least thirty (30) days before initiating arbitration. Such informal negotiations commence upon written notice from one Party to the other Party.Binding ArbitrationAny dispute arising from the relationships between the Parties to these Legal Terms shall be determined by one arbitrator who will be chosen in accordance with the Arbitration and Internal Rules of the European Court of Arbitration being part of the European Centre of Arbitration having its seat in Strasbourg, and which are in force at the time the application for arbitration is filed, and of which adoption of this clause constitutes acceptance. The seat of arbitration shall be Lisbon, Portugal. The language of the proceedings shall be Portuguese. Applicable rules of substantive law shall be the law of Portugal.RestrictionsThe Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilise class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.Exceptions to Informal Negotiations and Arbitration The Parties agree that the following Disputes are not subject to the above provisions concerning informal negotiations binding arbitration: (a) any Disputes seeking to enforce or protect, or concerning the validity of, any of the intellectual property rights of a Party; (b) any Dispute related to, or arising from, allegations of theft, piracy, invasion of privacy, or unauthorised use; and (c) any claim for injunctive relief. If this provision is found to be illegal or unenforceable, then neither Party will elect to arbitrate any Dispute falling within that portion of this provision found to be illegal or unenforceable and such Dispute shall be decided by a court of competent jurisdiction within the courts listed for jurisdiction above, and the Parties agree to submit to the personal jurisdiction of that court.</p>
                    </div>
                </section>

                <section id="section-15" className="scroll-mt-8">
                    <h2 className="text-2xl font-semibold mb-4">15. CORRECTIONS</h2>
                    <div className="space-y-4">
                ...
                <section id="section-16" className="scroll-mt-8">
                    <h2 className="text-2xl font-semibold mb-4">16. DISCLAIMER</h2>
                    <div className="space-y-4">
                ...
                <section id="section-17" className="scroll-mt-8">
                    <h2 className="text-2xl font-semibold mb-4">17. LIMITATIONS OF LIABILITY</h2>
                    <div className="space-y-4">
                ...
                <section id="section-19" className="scroll-mt-8">
                    <h2 className="text-2xl font-semibold mb-4">19. USER DATA</h2>
                    <div className="space-y-4">
                ...
                <section id="section-20" className="scroll-mt-8">
                    <h2 className="text-2xl font-semibold mb-4">20. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
                    <div className="space-y-4">
                ...
                <section id="section-21" className="scroll-mt-8">
                    <h2 className="text-2xl font-semibold mb-4">21. MISCELLANEOUS</h2>
                    <div className="space-y-4">
                ...
                <section id="section-22" className="scroll-mt-8">
                    ...
                    <div className="space-y-4">
                        <p>In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at: help@support.reqal.app</p>
                    </div>
                </section>
